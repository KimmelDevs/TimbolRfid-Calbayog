...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    setLoading(false);
    if (!role) { setError("Invalid email or password."); return; }
    ...
    <div style={{ display:"flex", minHeight:"100vh" }}>
      ...
      <div style={{
        ...
        <p className="fade-up delay-2" style={{ color:"#6b7280", fontSize:15, lineHeight:1.7, maxWidth:300 }}>
          Tap your RFID card and go — the modern fare system for Timbol motorized vehicles across Calbayog City.
        </p>
      ...
      <div style={{
        ...
        <div className="fade-up" style={{ width:"100%", maxWidth:420 }}>
          <h2 style={{ fontFamily:"Syne,sans-serif", fontSize:28, fontWeight:700, marginBottom:8 }}>Welcome back</h2>
          <p style={{ color:"#6b7280", fontSize:14, marginBottom:36 }}>
            Don&apos;t have an account?{" "}
            <Link href="/signup" style={{ color:"#f5a623", textDecoration:"none", fontWeight:500 }}>Sign up</Link>
          </p>

          {/* Demo hint */}
          <div style={{
            background:"rgba(245,166,35,0.07)", border:"1px solid rgba(245,166,35,0.2)",
            borderRadius:10, padding:"12px 16px", marginBottom:28, fontSize:13, color:"#f5a623"
          }}>
            <strong>Demo:</strong> resident → maria@timbol.ph / resident123 &nbsp;|&nbsp; admin → admin@timbol.ph / admin123
          </div>
