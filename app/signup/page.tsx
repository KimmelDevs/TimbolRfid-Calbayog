...
import { Eye, EyeOff, Zap, User, ShieldCheck } from "lucide-react";
    ...
    <div style={{ display:"flex", minHeight:"100vh" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background:"radial-gradient(circle, rgba(245,166,35,0.13) 0%, transparent 70%)", pointerEvents:"none"
        }}/>
        ...
        <h1 className="fade-up delay-1" style={{
          fontFamily:"Syne,sans-serif", fontSize:34, fontWeight:800, lineHeight:1.2, marginBottom:14,
        ...
        <p className="fade-up delay-2" style={{ color:"#6b7280", fontSize:15, lineHeight:1.7, maxWidth:300 }}>
          Register your RFID card and start riding Timbol vehicles across Calbayog City with ease.
        </p>
        ...
        <div className="fade-up" style={{ width:"100%", maxWidth:420 }}>
          ...
          <div style={{ display:"flex", gap:10, marginBottom:24 }}>
            {(["resident","admin"] as Role[]).map((r) => (
              <button key={r} type="button" onClick={()=>setRole(r)} style={{
                ...
                background: role===r ? "rgba(245,166,35,0.1)" : "#1a1f2e",
                border: role===r ? "1.5px solid rgba(245,166,35,0.5)" : "1px solid rgba(255,255,255,0.08)",
                borderRadius:10, cursor:"pointer", transition:"all 0.2s",
                display:"flex", flexDirection:"column", alignItems:"center", gap:8
              }}>
                {r==="resident"
                  ? <User size={20} color={role===r?"#f5a623":"#6b7280"}/>
                  : <ShieldCheck size={20} color={role===r?"#f5a623":"#6b7280"}/>
                }
                <span style={{
                  fontSize:13, fontWeight:600,
                  color: role===r ? "#f5a623" : "#6b7280",
          ...
          <form onSubmit={handleSubmit} style={{ display:"flex", flexDirection:"column", gap:16 }}>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              border:"none", borderRadius:10, color: loading ? "#6b7280" : "#fff",
